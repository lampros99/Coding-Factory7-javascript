const daysGR = ['Κυριακή', 'Δευτέρα', 'Τρίτη', 'Τετάρτη','Πεμπτή', 'Σάββατο']
const monthsGR = ['Ιανουαρίου', 'Φεβρουαρίου', 'Μαρτίου', 'Απριλίου', 'Μαίου', 'Ιουνίου', 'Ιουλίου', 'Αυγούστου', 'Σεπτεμβρίου', 'Οκτωμβρίου', 'Δεκεμβρίου']
...
window.addEventListener('DOMContentLoaded', function(){
    ...
    this.document.querySelector('#addNoteBtn').addEventListener('keyup',
        ...
        function renderNotes(){
            ...
            <label id="${'noteTxt' + note.key}" for="${'noteCheck' + note.key}" class="w-[200px] max-h-[150px] leading-[1.2rem] overflow-hidden break-words whitespace-normal text-base ${note.softDeleted ? 'line-through text-gray-500' : ''}">${note.note}</label></div>
